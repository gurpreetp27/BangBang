...
<td width="50%"><input type="text" name="NOM" size="24" value="{{$data['last_name']}}"></td>
</tr>
<tr>
<td width="50%">First name:</td>
<td width="50%"><input type="text" name="PRENOM" size="24" value="{{$data['name']}}"></td>
</tr>
<tr>
...
<!-- <input type="hidden" name="RETOURVOK" value="/return_klik"> -->
<input type="hidden" name="RETURN" value="http://50.116.49.118/bangbang?id=45">
<input type="hidden" name="MONTANT" value="{{$data['actual_amount']}}">
<!-- <input type="hidden" name="ABONNEMENT" value="{{$data['actual_amount']}}"> -->
<tr>
