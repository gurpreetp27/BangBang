...
@section('content')
            <div class="page-content fade-in-up">
                ...
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Add New template</div>
                    </div>
                    <div class="ibox">       
                            <div class="ibox-body">
                                <form action="{{url('admin/template/addnew/save')}}" method="post">
                                  @csrf
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input class="form-control" type="text" placeholder="template Title" name="title">
                                    </div>

                                    <div class="form-group">
                                        <label>Subject</label>
                                        <input class="form-control" type="text" placeholder="Email template subject" name="subject">
                                    </div>
                                   <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="10" id="summernote_air" name="content"></textarea>
                                    </div>
                                    <div class="form-group">
