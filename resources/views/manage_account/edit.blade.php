                                 ...
                                 @csrf 
                                  <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group">
                                         ...
                                         <div class="col-sm-6 form-group">
                                            <label>Last Name</label>
                                            <input class="form-control" type="text" placeholder="Amount" name="last_name" value="{{$user['email']}}">
                                        </div>
                                      
                                        <div class="col-sm-6 form-group">
                                            <label>Membership Expiry date</label>
                                            <input class="form-control" type="text" placeholder="Duration" name="duration" value="{{$user['getMembership']['end_date']}}">
                                        </div>
                                    </div>
