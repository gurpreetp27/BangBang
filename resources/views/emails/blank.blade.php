                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding: 20px 0 30px 0; color: #153643; font-family: 'Poppins', sans-serif; font-size: 16px; line-height: 20px;">
                                        ...
                                        <a href="{{$url}}" style="display: block;background-color:#d82211;color: #fff;width: 130px;text-align-last: center;margin-top: 40px;padding: 12px 15px;text-transform: uppercase;text-decoration: none;font-size: 18px;font-weight: 500; ">Confirm</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
